...
model = dict(
    ...
    test_cfg=dict(
        ...
        nms_pre=2000,
        score_thr=0.05,
        store_dir='baseline_pca28'),
    train_cfg=dict(
        cls_weight=1.0,
        multiple_factor=0.25,
        pca_length=28,
        store_ann_dir='/mnt/tmp/datasets/DOTAv10pseudolabel_baseline_pca28/',
        store_dir='baseline_pca28',
        thresh3=[
            0.03,
            0.04,
...
resume_from = 'checkpoints/train_cpm_epoch_6.pth'
runner = dict(max_epochs=7, type='EpochBasedRunner')
store_dir = 'baseline_pca28'
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(
...
work_dir = 'work_dirs/gen_baseline_pca28'
workflow = [
    (
        'train',
        1,
